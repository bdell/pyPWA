...
def complexV(resonance,wave,waves,normint,mass):
    ...
    """
    #return numpy.complex(magV(mass,resonance,wave,waves,normint)*numpy.cos(getPhi(mass,resonance)),magV(mass,resonance,wave,waves,normint)*numpy.sin(getPhi(mass,resonance)))
